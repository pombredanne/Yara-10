...
_IMAGE_OPTIONAL_HEADER_64 = [ ('Magic;',                                                    0x00,   ctypes.c_ushort, '<H'),
                              ('MajorLinkerVersion;',                                       0x02,   ctypes.c_byte,   '<B'),
                              ('MinorLinkerVersion;',                                       0x03,   ctypes.c_byte,   '<B'),
                              ('SizeofCode;',                                               0x04,   ctypes.c_uint32, '<L'),
                              ('SizeOfInitializedData;',                                    0x08,   ctypes.c_uint32, '<L'),
                              ...
                              ('AddressOfEntryPoint;',                                      0x10,   ctypes.c_uint32, '<L'),
                              ('BaseOfCode;',                                               0x14,   ctypes.c_uint32, '<L'),
                              ('ImageBase;',                                                0x18,   ctypes.c_uint64, '<Q'),
                              ('SectionAlignment;',                                         0x20,   ctypes.c_uint32, '<L'),
                              ('FileAlignment;',                                            0x24,   ctypes.c_uint32, '<L'),
                              ('MajorOperatingSystemVersion;',                              0x28,   ctypes.c_ushort, '<H'),
                              ('MinorOperatingSystemVersion;',                              0x2a,   ctypes.c_ushort, '<H'),
                              ...
                              ('Subsystem;',                                                0x44,   ctypes.c_ushort, '<H'),
                              ('DLLCharacteristics;',                                       0x46,   ctypes.c_ushort, '<H'),
                              ('SizeOfStackReserve;',                                       0x48,   ctypes.c_uint64, '<Q'),
                              ('SizeOfStackCommit;',                                        0x50,   ctypes.c_uint64, '<Q'),
                              ('SizeOfHeapReserve;',                                        0x58,   ctypes.c_uint64, '<Q'),
                              ('SizeOfHeapCommit;',                                         0x60,   ctypes.c_uint64, '<Q'),
                              ('LoaderFlags;',                                              0x68,   ctypes.c_uint32, '<L'),
                              ('NumberOfRvaAndSizes;',                                      0x6c,   ctypes.c_uint32, '<L'),
                              
                              ('IMAGE_DIRECTORY_ENTRY_EXPORT_TableVirtualAddress;',         0x70,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_EXPORT_Size;',                        0x74,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_IMPORT_VirtualAddress;',              0x78,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_IMPORT_Size;',                        0x7c,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_RESOURCE_TableVirtualAddress;',       0x80,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_RESOURCE_Size;',                      0x84,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_EXCEPTION_TableVirtualAddress;',      0x88,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_EXCEPTION_Size;',                     0x8c,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_SECURITY_TableVirtualAddress;',       0x90,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_SECURITY_Size;',                      0x94,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_BASERELOC_TableVirtualAddress;',      0x98,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_BASERELOC_Size;',                     0x9c,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_DEBUG_TableVirtualAddress;',          0xa0,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_DEBUG_Size;',                         0x94,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_COPYRIGHT_TableVirtualAddress;',      0xa4,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_COPYRIGHT_Size;',                     0xa8,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_GLOBALPTR_TableVirtualAddress;',      0xac,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_GLOBALPTR_Size;',                     0xb0,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_TLS_TableVirtualAddress;',            0xb4,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_TLS_Size;',                           0xb8,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG_TableVirtualAddress;',    0xbc,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG_Size;',                   0xc0,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT_TableVirtualAddress;',   0xc4,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT_Size;',                  0xc8,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_IAT_TableVirtualAddress;',            0xcc,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_IAT_Size;',                           0xd0,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT_TableVirtualAddress;',   0xd4,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT_Size;',                  0xd8,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR_TableVirtualAddress;', 0xdc,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR_IAT_Size;',            0xe0,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_RESERVED;',                           0xe4,   ctypes.c_uint32, '<L'),
                              ('IMAGE_DIRECTORY_ENTRY_RESERVED;',                           0xe8,   ctypes.c_uint32, '<L')]
