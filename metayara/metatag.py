...
_IMAGE_OPTIONAL_HEADER = [('Magic;',                                                    0x00,   ctypes.c_ushort, '<H'),
                          ...
                          ('SizeofCode;',                                               0x04,   ctypes.c_ulong, '<L'),
                          ('SizeOfInitializedData;',                                    0x08,   ctypes.c_ulong, '<L'),
                          ('SizeOfUninitializedData;',                                  0x0c,   ctypes.c_ulong, '<L'),
                          ('AddressOfEntryPoint;',                                      0x10,   ctypes.c_ulong, '<L'),
                          ('BaseOfCode;',                                               0x14,   ctypes.c_ulong, '<L'),
                          ('BaseOfDate;',                                               0x18,   ctypes.c_ulong, '<L'),
                          ('ImageBase;',                                                0x1c,   ctypes.c_ulong, '<L'),
                          ('SectionAlignment;',                                         0x20,   ctypes.c_ulong, '<L'),
                          ('FileAlignment;',                                            0x24,   ctypes.c_ulong, '<L'),
                          ...
                          ('Reserved1;',                                                0x34,   ctypes.c_ulong, '<L'),
                          ('SizeOfImage;',                                              0x38,   ctypes.c_ulong, '<L'),
                          ('SizeOfHeaders;',                                            0x3c,   ctypes.c_ulong, '<L'),
                          ('CheckSum;',                                                 0x40,   ctypes.c_ulong, '<L'),
                          ('Subsystem;',                                                0x44,   ctypes.c_ushort, '<H'),
                          ('DLLCharacteristics;',                                       0x46,   ctypes.c_ushort, '<H'),
                          ('SizeOfStackReserve;',                                       0x48,   ctypes.c_ulong, '<L'),
                          ('SizeOfStackCommit;',                                        0x4c,   ctypes.c_ulong, '<L'),
                          ('SizeOfHeapReserve;',                                        0x50,   ctypes.c_ulong, '<L'),
                          ('SizeOfHeapCommit;',                                         0x54,   ctypes.c_ulong, '<L'),
                          ('LoaderFlags;',                                              0x58,   ctypes.c_ulong, '<L'),
                          ('NumberOfRvaAndSizes;',                                      0x5c,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_EXPORT_TableVirtualAddress;',         0x60,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_EXPORT_Size;',                        0x64,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_IMPORT_VirtualAddress;',              0x68,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_IMPORT_Size;',                        0x6c,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_RESOURCE_TableVirtualAddress;',       0x70,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_RESOURCE_Size;',                      0x74,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_EXCEPTION_TableVirtualAddress;',      0x78,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_EXCEPTION_Size;',                     0x7c,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_SECURITY_TableVirtualAddress;',       0x80,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_SECURITY_Size;',                      0x84,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_BASERELOC_TableVirtualAddress;',      0x88,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_BASERELOC_Size;',                     0x8c,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_DEBUG_TableVirtualAddress;',          0x90,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_DEBUG_Size;',                         0x94,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_COPYRIGHT_TableVirtualAddress;',      0x98,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_COPYRIGHT_Size;',                     0x9c,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_GLOBALPTR_TableVirtualAddress;',      0xa0,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_GLOBALPTR_Size;',                     0xa4,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_TLS_TableVirtualAddress;',            0xa8,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_TLS_Size;',                           0xac,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG_TableVirtualAddress;',    0xb0,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_LOAD_CONFIG_Size;',                   0xb4,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT_TableVirtualAddress;',   0xb8,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_BOUND_IMPORT_Size;',                  0xbc,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_IAT_TableVirtualAddress;',            0xc0,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_IAT_Size;',                           0xc4,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT_TableVirtualAddress;',   0xc8,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_DELAY_IMPORT_Size;',                  0xc8,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR_TableVirtualAddress;', 0xd0,   ctypes.c_ulong, '<L'),
                          ('IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR_IAT_Size;',            0xd4,   ctypes.c_ulong, '<L'),
